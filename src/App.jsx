...
// ─── DATA ─────────────────────────────────────────────────────────────────────
const EDU = [
  {id:"EDU-01",title:"B.E. — ELECTRICAL & ELECTRONICS ENGINEERING",inst:"PSG College of Technology, Coimbatore",period:"2023 – 2027",year:"2023",note:"Current — 3rd Year"},
  {id:"EDU-02",title:"12TH GRADE (HSC)",inst:"Kongu Vellalar Matric Hr Sec School, Coimbatore",period:"March 2023",year:"2023",note:"Centum in Physics, Chemistry & Mathematics — Academic Excellence Award"},
  {id:"EDU-03",title:"10TH GRADE (SSLC)",inst:"Holy Rosary Matriculation School, Coimbatore",period:"March 2021",year:"2021",note:""},
];
...
const CT_LINES = [
  ...
  {prompt:"SYS >",cmd:" open --connection-request",delay:1700},
...
const TV=<svg width="20" height="20" viewBox="0 0 10 10" fill="var(--red)"><rect x="0" y="0" width="2" height="2" opacity="0.4"/><rect x="2" y="0" width="2" height="2"/><rect x="4" y="0" width="2" height="2"/><rect x="6" y="0" width="2" height="2"/><rect x="8" y="0" width="2" height="2" opacity="0.4"/><rect x="4" y="2" width="2" height="2"/><rect x="4" y="4" width="2" height="2"/><rect x="4" y="6" width="2" height="2"/><rect x="2" y="8" width="2" height="2" opacity="0.3"/><rect x="6" y="8" width="2" height="2" opacity="0.3"/></svg>;
...
const css = `
  ...
  *{margin:0;padding:0;box-sizing:border-box}
  ...
  .h-eye{font-family:'Share Tech Mono';font-size:.48rem;letter-spacing:5px;color:var(--tfaint);margin-bottom:.7rem}
  ...
  .scell::before{content:attr(data-l);font-family:'Orbitron';font-size:.4rem;font-weight:600;letter-spacing:2px;color:var(--tfaint);display:block;margin-bottom:.35rem}
  ...
  .ssub{font-family:'Share Tech Mono';font-size:.46rem;color:var(--tfaint);letter-spacing:1px}
  ...
  .stag{font-family:'Orbitron';font-size:.4rem;font-weight:600;letter-spacing:2px;color:var(--tfaint);border:1px solid var(--b2);padding:2px 8px}
  ...
  /* ── CONTACT ── */
  .contact-wrap{display:flex;flex-direction:column;gap:1.4rem;padding-bottom:.2rem}
  .cterm{min-height:140px}
  .soc-row{display:flex;justify-content:center;gap:1.2rem;flex-wrap:wrap;padding-bottom:.4rem}
  ...
  .edu-item{display:flex;gap:0;align-items:flex-start;position:relative;margin-bottom:.85rem}
  .edu-item:last-child{margin-bottom:0}
  /* vertical line drawn through gutter pseudo */
  .edu-item:not(:last-child)::before{content:'';position:absolute;left:21px;top:26px;bottom:-0.85rem;width:1px;background:linear-gradient(180deg,var(--red),var(--b2));z-index:0}
  .edu-gutter{width:44px;flex-shrink:0;display:flex;flex-direction:column;align-items:center;padding-top:1.1rem;position:relative;z-index:1}
  .edu-dot{width:11px;height:11px;border-radius:50%;border:2px solid var(--red);background:transparent;flex-shrink:0}
  .edu-dot.current{background:var(--red);animation:dot-pulse 2s ease-out infinite}
  @keyframes dot-pulse{0%{box-shadow:0 0 0 0 var(--rdim)}60%{box-shadow:0 0 0 7px rgba(224,60,60,0)}100%{box-shadow:0 0 0 0 rgba(224,60,60,0)}}
  .edu-year{font-family:'Share Tech Mono';font-size:.42rem;color:var(--tfaint);margin-top:.3rem;letter-spacing:1px;white-space:nowrap}
  .edu-card{flex:1;background:var(--panel);border:1px solid var(--b1);padding:1rem 1.2rem;position:relative;transition:border-color .2s,background .35s}
  ...
  .edu-card:hover{border-color:var(--b2)}
  ...
  .eperiod{font-family:'Share Tech Mono';font-size:.52rem;color:var(--tfaint);margin-top:.2rem}
  .enote{font-family:'Share Tech Mono';font-size:.56rem;color:var(--tfaint);margin-top:.25rem;border-left:2px solid var(--red);padding-left:.5rem}

  /* ── PROJECTS ── */
  .pgrid{display:grid;grid-template-columns:repeat(auto-fill,minmax(290px,1fr));gap:1.1rem}
  @media(max-width:640px){.pgrid{grid-template-columns:1fr}}
  .pc{background:var(--panel);border:1px solid var(--b1);padding:1.4rem;position:relative;transition:border-color .25s,background .35s;cursor:pointer;overflow:visible}
  ...
  .pid{font-family:'Share Tech Mono';font-size:.46rem;letter-spacing:2px;color:var(--tfaint);margin-bottom:.4rem}
  .ptitle{font-family:'Orbitron';font-size:.72rem;font-weight:700;color:var(--tx);letter-spacing:1px;margin-bottom:.55rem;line-height:1.35}
  .pdesc{font-family:'Share Tech Mono';font-size:.67rem;color:var(--tdim);line-height:1.9}
  .pfoot{margin-top:.9rem;padding-top:.75rem;border-top:1px solid var(--b1);display:flex;justify-content:space-between;align-items:center;flex-wrap:wrap;gap:.4rem}
  ...
  .modal-period{font-family:'Share Tech Mono';font-size:.52rem;color:var(--tfaint);letter-spacing:1px;margin-bottom:.6rem;opacity:0;animation:fadein .2s .46s forwards;position:relative;z-index:1}
  ...
  .log-hd{display:flex;justify-content:space-between;align-items:center;padding:.6rem 1.1rem;border-bottom:1px solid var(--b2);background:var(--b1);font-family:'Orbitron';font-size:.42rem;font-weight:600;letter-spacing:2px;color:var(--tfaint);flex-wrap:wrap;gap:.4rem}
  ...
  .lts{font-family:'Share Tech Mono';font-size:.5rem;color:var(--tfaint);white-space:nowrap;padding-top:.14rem}
  ...
  .lchev{font-family:'Share Tech Mono';font-size:.52rem;color:var(--tfaint);align-self:start;padding-top:.14rem;transition:transform .3s;flex-shrink:0}
  ...
  /* ── FOOTER ── */
  .site-footer{border-top:1px solid var(--b1);padding:.7rem 1.2rem;display:flex;align-items:center;justify-content:center}
  .footer-inner{max-width:1260px;width:100%;display:flex;justify-content:center;align-items:center;gap:1.4rem;flex-wrap:wrap}
  .footer-item{font-family:'Share Tech Mono',monospace;font-size:.52rem;color:var(--tfaint);letter-spacing:1px}
  ...
  .egg-hint{position:fixed;bottom:1.4rem;left:50%;transform:translateX(-50%);font-family:'Share Tech Mono';font-size:.5rem;color:var(--tfaint);letter-spacing:2px;pointer-events:none;animation:fdin .3s ease;white-space:nowrap}
  ...
  @media(max-width:700px){
    ...
    .edu-gutter{width:30px}
    .edu-year{display:none}
    .edu-item:not(:last-child)::before{left:15px}
  }
...
function useRandomDecrypt(text, trigger, totalDuration = 3200) {
  ...
  useEffect(() => {
    ...
    const iv = setInterval(()=>{if(!alive)return;setChars(p=>p.map((ch,i)=>ch.settled?ch:{...ch,c:arr[i]===" "?" ":rg()}));},60);
...
export default function App() {
  ...
  const [bioRef, bioActive] = useScrollTrigger();
  ...
  useEffect(()=>{document.title="SATHYAJITH — Diagnostic Terminal | EEE Portfolio";},[]);
  ...
  return (<>
    ...
    <div className="breadcrumb">
      ...
      <span style={{color:"var(--tfaint)",fontFamily:"'Share Tech Mono',monospace",fontSize:".44rem",letterSpacing:"1px"}}>&nbsp;{breadcrumb}</span>
      ...
      <div className="edu-timeline fu" ref={useFU()}>
        {EDU.map((e,i)=>(
          <div key={e.id} className="edu-item">
            <div className="edu-gutter">
              <div className={`edu-dot${i===0?" current":""}`}/>
